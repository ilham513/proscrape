			...
			foreach($html->find('a') as $element) {
				if( substr($element->href,0,7) == '/posts/' ){
					...
					<div class="w3-card-4 <? if(strpos($img_title, 'animated')){echo 'w3-black';} ?>">
						<div>
							<img id="566" src="<? echo $gambar_post ?>" class="w3-image w3-margin-top" loading=”lazy” width="80%">
							<br/>
							...
							<div class="w3-row w3-margin-right">
							  <div class="w3-col s6 w3-container">
								<a href="#"><button  type="button" class="w3-padding-16 w3-margin w3-button w3-theme-d1 w3-margin-bottom w3-large w3-red w3-block"><i class="fa fa-times"></i> Hardcore</button></a>
							  </div>
							  <div class="w3-col s6 w3-container">
								<a href="like.php?id=566&page="><button  type="button" class="w3-padding-16 w3-margin w3-button w3-theme-d1 w3-margin-bottom w3-large w3-green w3-block"><i class="fa fa-check"></i> Softcore</button></a>
							  </div>
							</div>							
						</div>
					</div>
