		...
		<div class="w3-container">
			<?php foreach($array_gambar as $i=>$gambar): ?>
				...
				<div id="<?= $i ?>" class="w3-col w3-display-container w3-card s<?= $bootstrapColWidth ?>">
					...
					<a href="danbooru_filter.php?danbooru_id=<?=$gambar['id']?>&callback_dir=index&callback_id=<?= $i?>&callback_p=<?= $_GET['p']?>"><img src="//imagex.aratech.co/?url=<?= str_replace("https://", "", $gambar['url'])?>"/></a>
				</div>
