...
$url = "https://rule34.xxx/index.php?page=post&s=list&tags=genshin_impact";

if(isset($_GET['p'])){
	$url = "https://rule34.xxx/index.php?page=post&s=list&tags=genshin_impact&pid=". $_GET['p'] * 42;
}
...
<body bgcolor="white">
	...
	<div class="w3-container">
		<a href="genshin.php?p=<?= $_GET['p'] + 1 ?>"><button class="w3-button w3-block w3-large w3-teal">NEXT</button></a>
	</div>
